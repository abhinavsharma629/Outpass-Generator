...
<label for="er_no">Enrollment Number</label>
<input type="text" class="form-control" id="er_no" placeholder="Enrollment Number">
</div>
</div>
...
<select id="year" class="form-control">
  ...
  <option value="1">I (First)</option>
  <option value="2">II (Second)</option>
  <option value="3">III (Third)</option>
  <option value="4">IV (Fourth)</option>
  <option value="5">V (Fifth)</option>
  <option value="6">VI (Sixth)</option>
</select>
</div>
...
<select id="sem1" class="form-control">
  ...
  <option value="5">V (Fifth)</option>
  <option value="6">VI (Sixth)</option>
  <option value="7">VII (Seventh)</option>
  <option value="8">VIII (Eighth)</option>
</select>
</div>

<div class="form-group col-md-3">
<label for="hostel">Hostel</label>
<input type="text" class="form-control" id="hostel" placeholder="Hostel Number">
</div>
<div class="form-group col-md-3">
<label for="room_no">Room No.</label>
<input type="number" class="form-control" id="room_no" placeholder="Room Number">
</div>
<div class="form-group col-md-2">
<label for="bed_no">Bed No.</label>
<input type="number" class="form-control" id="bed_no" placeholder="Bed Number">
</div>
</div>
...
<input type="text" class="form-control" id="parent" placeholder="Parent's Name">
</div>
<div class="form-group col-md-3">
<label for="parent_contact">Parent's Contact</label>
<input type="text" class="form-control" id="parent_contact" placeholder="Parent's Contact">
</div>

<div class="form-group col-md-5">
<label for="warden">Warden</label>
<select id="warden" class="form-control">
...
<label class="form-check-label" for="gridCheck">
  I Abide To All The Rules And Accept That All The Information Filled Is Accurate !!
</label>
</div>
</div>
...
<button class="btn btn-warning" id="showPointsToggle">Show points?</button>
</div>
...
<br>
<br>
<button type="submit" id="save11" class="btn btn-primary" style="margin-left:40%;">Save</button>
  ...
  `
    ...
    $("#warden").change(function(){
      ...
      alert("Changing the warden will cancel all your pending requests and approved outpasses to your current warden!!")
    })
