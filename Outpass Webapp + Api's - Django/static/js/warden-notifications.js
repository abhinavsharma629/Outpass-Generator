function notifications() {
  ...
  $("#notifications1").attr("style", "display:block;");
  ...
  $("#myoutpass1").attr('style', "display:none;");
    ...
    <div class="card-body">
    <div class="row">
      <h5 class="card-title float-left">Notifications</h5>
      <p class="text-muted float-right">&nbsp;&nbsp;12/07/1998</p>
  </div>
  ...
  if ($("#notifications1").html()) {
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        var html = "";
        $("#notifications1").html(html);
        for (var i = 0; i < approved_outpasses.length; i++) {

          html +=
            `<div class="card" id="card-` +
            approved_outpasses[i]['id'] +
            `">
              <h5>` +
            approved_outpasses[i]["sender_f"] +` `+approved_outpasses[i]["sender_l"]+
            `</h5>
              <div class="title"><b>Accepted On:-
              `+approved_outpasses[i]["date"]+`</b></div>
              <div class="desc"><b>` +
            approved_outpasses[i]['text'] +
            `</b></div>
              <div class="actions">`;
